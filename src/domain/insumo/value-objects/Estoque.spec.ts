...
describe('Estoque', () => {
  ...
  it('lança DomainError quando reserva inicial excede quantidade', () => {
    expect(() => Estoque.create(5, 0, 6)).toThrow(DomainError);
  });
